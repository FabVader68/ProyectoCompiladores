...
public class ClaseEvalGramaticas {
        ...
        System.out.println("/nLexema: "+analizador.getLexema());
    ...
    public String iniEvalGramaticas(String aux){
           int token;
           if(G()){
               token = L.yylex();
               ...
               if(token == 0){
                  ...
                  aux += "Numero de reglas: " + NumReglas + "\n";
                  /*
                  ...
                  */
                  ...
                  for(int i=0;i<NumReglas;i++){
                      ...
                      aux += Reglas[i].s.c+":("+Reglas[i].lista.lista.size()+")";
